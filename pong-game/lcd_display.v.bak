...
begin
	...
	//	Line 1
   LCD_LINE1+0: LUT_DATA <= 9'h120; // Spatie
	LCD_LINE1+1: LUT_DATA <= 9'h150; // P
	LCD_LINE1+2: LUT_DATA <= 9'h16F; // o
	LCD_LINE1+3: LUT_DATA <= 9'h16E; // n
	LCD_LINE1+4: LUT_DATA <= 9'h167; // g
   LCD_LINE1+5: LUT_DATA <= 9'h120; // spatie
	LCD_LINE1+6: LUT_DATA <= 9'h147; // G
